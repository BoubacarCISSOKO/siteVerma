					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 p-fix">
						<div class="blog-details-post-wrapper" style="font-family:Times New Roman; color:#000000; font-size:20px">
							...
							<div class="post-heading">
								<h4>La Riziculture à VERMA</h4>
								<span>La valée du fleuve SENEGAL</span>
							</div> <!-- /.post-heading -->
							<p>En Afrique Noire où il est difficile de définir et de délimiter les "pays", la valée du Sénégal, de Bakel à la mer, sur 800 kilomètres, présente une forte industrialisation pour toute la popution. En effet, après la saison des pluies, c'est la préparation de cette briante époque. L'année 2019 marque le début de la riziculture à Verma. A noter qu'à l'époque, nos ancétres pratiquaient cette culture mais qui avait disparue vers les années 2000. Le taux de réussite n'a pas atteint 100% car la machine à arrosage avait eu des problémes en pleine milieu. </p>
							
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<p><i class="fa fa-quote-left" aria-hidden="true"></i>La culture du mais qui chaque annnée affiche un taux de réussite très satisfaisant pour toute la population.<i class="fa fa-quote-right" aria-hidden="true"></i></p>
								</div> <!-- /.col -->
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		        ...
		        <div class="row">
				  	...
				  	<div class="col-sm-12 col-md-12 col-lg-12">
						  ...
						  <div style="margin-top: 20px; background: white; box-shadow: 0 5px 10px rgba(0, 0, 0, .09); padding: 5px 10px; border-radius: 10px">
								 ...
								 <h3 style="text-align: center">L'ensemble des commentaires postés</h3>
			                        ...
			                        ?>
			                            <div class="news">
			                                <p>Le titre du commentaire est: <strong><?php echo $donnees['titre']; ?></strong><br/>
			                                	...
			                                	publié le <?php echo $donnees['date_creation']; ?> par <strong><?php echo $donnees['auteur']; ?></strong></p><hr style="width: 100%; border:2px solid">
			                            </div>
			                        <?php
			                        }
			                        $req->closeCursor();
